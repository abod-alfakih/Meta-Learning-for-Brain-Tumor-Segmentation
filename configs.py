...
def parse_seg_args():
    ...
    parser.add_argument('--num_workers', type=int, default=15, help='number of workers to load data')
    ...
    parser.add_argument('--unet_arch', type=str, default='unetr',
        choices=['unet','unetr' 'BasicUNetPlusPlus', 'SwinUNETR'], help='Architecuture of the U-Net')
    parser.add_argument('--block', type=str, default='plain', choices=['plain', 'res'],
        help='Type of convolution block')
    parser.add_argument('--channels_list', nargs='+', type=int, default=[32, 32, 64, 128, 256, 32],
